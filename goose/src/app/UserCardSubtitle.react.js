...
export default function UserCardSubtitle(): React$Node {
  return (
    <div className={StyleResolver.resolve([styles.container])}>
      <div className={StyleResolver.resolve([styles.item])}>
        <svg
        ...
        <p>
          <span className={StyleResolver.resolve([styles.bold])}>3</span> Bedrooms
        </p>
      </div>
      <div className={StyleResolver.resolve([styles.item])}>
        <svg
        ...
        <p>
          <span className={StyleResolver.resolve([styles.bold])}>2</span> Bathrooms
        </p>
      </div>
    </div>
  );
